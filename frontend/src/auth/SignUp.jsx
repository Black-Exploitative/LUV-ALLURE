      ...
      <div className="flex-grow flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-md space-y-10">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-thin md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst text-gray-900">CREATE AN ACCOUNT</h1>
