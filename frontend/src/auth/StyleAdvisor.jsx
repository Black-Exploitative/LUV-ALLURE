        ...
        <div className="space-y-8">
          ...
          {quizStep === 3 && (
                      <motion.div 
                        ...
                        className="space-y-8"
                      >
                        <h4 className="text-sm font-medium mb-6">SELECT STYLES THAT RESONATE WITH YOU</h4>
                              ...
                              <div className="absolute inset-0 bg-gray-200 flex items-center justify-center">
                                <div className="text-center p-2">
                                  <div className="text-2xl mb-2">
                                    {idx % 8 === 0 ? "✨" : idx % 8 === 1 ? "🌟" : idx % 8 === 2 ? "🎨" : idx % 8 === 3 ? "🌿" : 
                                     idx % 8 === 4 ? "📐" : idx % 8 === 5 ? "🧵" : idx % 8 === 6 ? "🧶" : "💫"}
                                  </div>
                    ...
                    {quizStep === 4 && (
                      ...
                      >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          <div>
                            <h4 className="text-sm font-medium mb-4">OCCASIONS YOU DRESS FOR</h4>
                            <div className="space-y-3">
                              {[
                                ...
                                <motion.div 
                                  key={idx}
                                  className={`flex items-center space-x-2 px-4 py-3 border cursor-pointer ${
                                    occasions.includes(item) ? "border-black bg-gray-50" : "border-gray-200"
                                  }`}
                                  whileHover={{ x: 5, borderColor: "#000" }}
                                  onClick={() => {
                                ...
                                >
                                  ...
                                  />
                                  <label htmlFor={`occasion-${idx}`} className="text-sm cursor-pointer flex-grow">
                                    {item}
                                  </label>
                                </motion.div>
                              ))}
                          ...
                          <div>
                            <h4 className="text-sm font-medium mb-4">DESIGNER PREFERENCES</h4>
                            <div className="grid grid-cols-2 gap-4">
                              {[
                                "Italian Heritage", 
                                "French Ateliers", 
                                ...
                                <motion.div 
                                  key={idx}
                                  className={`border p-3 cursor-pointer ${
                                    designers.includes(designer) ? "border-black bg-gray-50" : "border-gray-200"
                                  }`}
                                  whileHover={{ y: -3, borderColor: "#000" }}
                                  onClick={() => {
                                    if (designers.includes(designer)) {
                                      setDesigners(designers.filter(d => d !== designer));
                                    } else {
                    ...
                    {quizStep === 5 && (
                      <motion.div 
                        ...
                        className="space-y-8"
                      >
                        <h4 className="text-sm font-medium mb-4">FINALIZE YOUR STYLE PROFILE</h4>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          <div>
                            <div className="p-6 border border-gray-200 bg-gray-50">
                              <h5 className="font-medium text-sm mb-4">YOUR SELECTIONS</h5>
                              <div className="space-y-4 text-sm">
                                <div>
                                  <span className="text-gray-500">Style Inspiration:</span>
                                ...
                                <div>
                                  <span className="text-gray-500">Designer Preferences:</span>
                                  <p>{designers.join(", ")}</p>
                                </div>
                              </div>
                            </div>
                          ...
                          <div>
                            <div className="p-6 border border-gray-200">
                              <h5 className="font-medium text-sm mb-4">CONTACT DETAILS</h5>
                              <form className="space-y-4">
                                ...
                                <div className="flex items-start mt-4">
                                  ...
                                  <div className="ml-3 text-xs">
                                    <label htmlFor="notify-style" className="text-gray-700">
                                      I would like to receive style updates and new collection notifications.
                                    </label>
                                  </div>
                                </div>
                              </form>
                      ...
                      >
                        ...
                        >
                          <div className="text-center space-y-6">
                            ...
                            <h3 className="text-2xl font-light tracking-wide">STYLE PROFILE COMPLETED</h3>
                            
                            <p className="text-sm text-gray-600">
                              Thank you for completing your style profile. Our professional stylists will create a personalized style guide based on your preferences. You will receive it via email within 24-48 hours.
                            </p>
