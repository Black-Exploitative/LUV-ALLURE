...
export default function ShoppingBag() {
  ...
  return (
    <div className="bg-white"> {/* Removed min-h-screen for proper content sizing */}
      <Navbar />
      ...
      {/* Added wrapper with conditional padding for RecentlyViewedProducts */}
      <div className={isMobile ? "pb-28" : "pb-0"}>
        <RecentlyViewedProducts />
      </div>
      
      {/* Floating Checkout Button for Mobile - Added z-index */}
      {isMobile && cartItems.length > 0 && (
        <div className="fixed bottom-0 left-0 right-0 bg-white py-3 px-4 shadow-lg border-t z-10">
          <button 
