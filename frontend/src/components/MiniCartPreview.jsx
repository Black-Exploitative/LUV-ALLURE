    ...
    >
      ...
      <AnimatePresence>
        {isHovering && (
          ...
          >
            <div className="p-4">
              <h3 className="text-sm font-medium uppercase md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst mb-3 pb-2 border-b border-gray-100">
              ...
              <div className="mt-4 space-y-2">
                <button 
                  ...
                  className="w-full cursor-pointer bg-black text-white text-xs uppercase md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst py-2 hover:bg-gray-900 transition-colors"
                >
                  Checkout
                </button>
                <button 
                  ...
                  className="w-full cursor-pointer bg-white text-black border border-black text-xs uppercase md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst py-2 hover:bg-gray-50 transition-colors"
                >
                  View Bag
                </button>
              </div>
