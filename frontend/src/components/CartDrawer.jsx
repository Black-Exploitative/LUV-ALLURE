            ...
            {displayItems.length > 0 && (
              <div className="border-t border-gray-200 p-6 bg-white">
                ...
                <div className="space-y-3">
                  <button 
                    className="w-full bg-black text-white py-3 hover:bg-gray-900 transition-colors text-sm uppercase md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst cursor-pointer"
                    onClick={() => {
                  ...
                  <button 
                    className="w-full bg-white text-black border border-black py-3 hover:bg-gray-50 transition-colors text-sm uppercase md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst cursor-pointer"
                    onClick={() => {
                      setIsCartDrawerOpen(false);
