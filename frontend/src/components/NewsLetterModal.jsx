        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-center text-center">
              {!submitted ? (
                <>
                  <div className="font-serif md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr :tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr  lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2 lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst text-xl mb-1">
                    LUV'S ALLURE
                  </div>
                  {/* Border line */}
                  ...
                  {/* Message */}
                  <p className="text-sm  mb-8 max-w-xs font-thin sm:tracking-tight  md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-wider  text-gray-800 font-base font-[Raleway] ">
