      ...
      <div className="bg-white w-full max-w-xl max-h-[90vh] overflow-y-auto rounded">
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* Add Media */}
            <div className="mb-6">
              <label className="block mb-2 font-medium">Add media</label>
              <button
                type="button"
                className="border border-gray-300 rounded p-3 flex items-center"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h12a2 2 0 012 2v8a2 2 0 01-2 2h-2" />
                </svg>
                Upload
              </button>
              <p className="text-xs text-gray-500 mt-1">
