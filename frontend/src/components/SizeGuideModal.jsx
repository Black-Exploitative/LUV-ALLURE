        ...
        >
          ...
          >
            ...
            <div className="px-6 pt-8 pb-4">
              <h2 className="text-2xl font-thin tracking-wider text-center">
                SIZE GUIDE
              </h2>
              <motion.div
            ...
            <div className="flex justify-center px-6 mb-6">
              <div className="flex space-x-12 border-b">
                <motion.button
                  className={`pb-2 px-1 text-sm tracking-wider ${
                      ...
                      {sizeCharts[activeTab].sizes.map((size, rowIndex) => (
                        ...
                        >
                          {size.map((cell, cellIndex) => (
                            <td
                              key={cellIndex}
                              className="px-4 py-3 text-center text-gray-800 font-thin tracking-wide"
                            >
                              {cell}
                            </td>
                          ))}
