          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-64 p-6 bg-white shadow-sm">
              ...
              <div className="mb-6">
                ...
                >
                  <h3 className="font-medium text-sm text-gray-800 md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst">COLOUR</h3>
                  {isColorOpen ? 
              ...
              <div className="mb-6">
                ...
                >
                  <h3 className="font-medium text-sm text-gray-800 md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst">SIZE</h3>
                  {isSizeOpen ? 
                    <FaChevronUp className="text-gray-500" /> : 
                    <FaChevronDown className="text-gray-500" />
                  }
              ...
              <div className="mb-6">
                ...
                >
                  <h3 className="font-medium text-sm text-gray-800 md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst">CATEGORY</h3>
                  {isCategoryOpen ? 
                    <FaChevronUp className="text-gray-500" /> : 
                    <FaChevronDown className="text-gray-500" />
                  }
            ...
            <div className="w-full md:flex-1 p-6 bg-white shadow-sm" ref={resultsContainerRef}>
              <div className="flex justify-between items-center border-b border-gray-200 pb-3 mb-6">
                <h3 className="font-medium text-sm text-gray-800 md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst">PRODUCT RESULTS</h3>
                    ...
                    >
                      ...
                      <div className="aspect-[3/4] overflow-hidden bg-gray-50 mb-3 relative">
                        ...
                        <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                          <span className="bg-white bg-opacity-90 px-4 py-2 text-xs uppercase md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst text-black">
                            Quick View
                          </span>
                        </div>
                      </div>
