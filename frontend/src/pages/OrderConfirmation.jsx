    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-light uppercase tracking-wider mb-3">Thank You For Your Order</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 mb-8">
          ...
          <div className="mb-6">
            <div className="flex items-center mb-2">
              ...
              <h3 className="font-medium">Status: {order.status.charAt(0).toUpperCase() + order.status.slice(1)}</h3>
            </div>
            <p className="text-sm text-gray-600">We'll email you an update when your order ships.</p>
          </div>
          ...
          <div className="relative mb-8 pl-8 border-l border-gray-200">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Estimated delivery: {order.estimatedDeliveryDays || "3-5"} business days</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div>
              ...
              {order.paymentDetails?.cardLast4 && <p>Card ending in ****{order.paymentDetails.cardLast4}</p>}
          ...
          {/* Order items */}
          <div>
            <h3 className="font-medium mb-4 pb-2 border-b border-gray-100">Order Items</h3>
            <div className="space-y-4">
              {order.items.map((item, index) => (
                <div key={index} className="flex items-center border-b border-gray-50 pb-4">
        ...
        <div className="text-center">
          ...
          <Link to="/contact-us" className="text-black underline hover:text-gray-700">
            Contact Support
          </Link>
        </div>
      </div>
