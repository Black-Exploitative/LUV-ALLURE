  ...
  return (
    <div className="relative bg-white min-h-screen">
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        >
          <h1 className="text-3xl md:text-5xl font-light tracking-widest text-gray-900">
            ALL COLLECTIONS
          </h1>
        ...
        >
          <h2 className="text-3xl md:text-4xl font-light tracking-widest text-gray-900 text-center mb-16">
            NEW ARRIVALS
          </h2>
