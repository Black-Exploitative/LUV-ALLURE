  ...
  const contactMethods = [
    {
      ...
      items: [
        ...
        },
        {
          icon: <FaEnvelope />,
          label: "Email",
          value: "support@luvallure.com",
          link: "mailto:support@luvallure.com",
        },
        {
          icon: <FaWhatsapp />,
          label: "WhatsApp",
      ...
      >
        ...
        <div className="relative h-[60vh] bg-[#f8f6f4] flex items-center justify-center overflow-hidden mt-[70px]">
          ...
          >
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl font-light tracking-[0.15em] uppercase mb-6 text-black"
            >
              Contact Us
            </motion.h1>
            <motion.div
              ...
              className="w-16 h-[1px] bg-black mx-auto mb-6"
            ></motion.div>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.2 }}
              className="text-lg md:text-xl font-light tracking-wider text-black"
            >
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-light tracking-wide mb-12 uppercase">
                How Can We Help?
              </h2>
                          ...
                          {method.items.map((item, itemIndex) => (
                            ...
                            >
                              ...
                              <div>
                                ...
                                <p className="font-light tracking-wide group-hover:underline">
                                  {item.value}
                                </p>
                              </div>
                            </motion.a>
              ...
              {formSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="mt-12">
                    <motion.button
                      type="submit"
                      className="px-8 py-4 bg-black text-white uppercase tracking-wider text-sm hover:bg-gray-800 transition-colors duration-300"
        ...
        >
          <div className="text-center max-w-2xl mx-auto px-6">
            <h2 className="text-2xl md:text-3xl font-light tracking-wide mb-6 uppercase">
              Our Global Presence
            </h2>
            ...
            <motion.a
              href="/store-locator"
              className="inline-block px-8 py-4 border border-black uppercase tracking-wider text-sm hover:bg-black hover:text-white transition-colors duration-300"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              Find a Store
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              ...
              <form className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
                ...
                <motion.button
                  type="submit"
                  className="px-8 py-3 bg-black text-white uppercase tracking-wider text-sm hover:bg-gray-800 transition-colors duration-300 whitespace-nowrap"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  Subscribe
