      ...
      >
        ...
        <div className="relative h-[60vh] bg-[#f8f6f4] flex items-center justify-center overflow-hidden mt-[70px]">
          ...
          >
            ...
            <motion.p
              ...
              className="text-lg md:text-xl font-thin md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerstr text-black"
            >
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-thin md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst mb-12 uppercase">
                How Can We Help?
              </h2>
              ...
              {formSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="mt-12">
                    <motion.button
                      type="submit"
                      className="px-8 py-4 bg-black text-white uppercase md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerstr text-sm hover:bg-gray-800 transition-colors duration-300"
        ...
        >
          <div className="text-center max-w-2xl mx-auto px-6">
            <h2 className="text-2xl md:text-3xl font-thin md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerst mb-6 uppercase">
              Our Global Presence
            </h2>
            ...
            <motion.a
              href="/store-locator"
              className="inline-block px-8 py-4 border border-black uppercase md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerstr text-sm hover:bg-black hover:text-white transition-colors duration-300"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              Find a Store
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              ...
              <form className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
                ...
                <motion.button
                  type="submit"
                  className="px-8 py-3 bg-black text-white uppercase md:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr lg:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerr 2xl:md:tracking-wide lg:tracking-wide xl:tracking-wider 2xl:tracking-widerstr text-sm hover:bg-gray-800 transition-colors duration-300 whitespace-nowrap"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  Subscribe
